...
//      screen).
//
// The History section has no screen yet (Phase C); its rail/sidebar nav
// item navigates to a "coming soon" placeholder so it's never dead. Presets
// (C3) joins Models (B8) and Connections (B7) as the screens wired in here
